...
// import HomeScreen from './HomeScreen';
// import SplashScreen from './SplashScreen';
// import * as LocationBackgroundTask from './LocationBackgroundTask'; // Import the background task

// const Tab = createBottomTabNavigator();
// const Stack = createStackNavigator();

// const App = () => {
//   // Start the background location task when the app loads
//   useEffect(() => {
//     LocationBackgroundTask.startBackgroundLocationTask();
//   }, []);
...
//           headerLeft: null, // Remove the back button
//         })} />
//       <Tab.Screen name="Direction" component={DirectionScreen}
//         options={() => ({
//           headerShown: false,
//           headerLeft: null, // Remove the back button
//         })} />
